...
import com.bond.android_ipc.servs.AIDLService;

import java.util.ArrayList;
import java.util.concurrent.CompletableFuture;
import java.util.concurrent.TimeUnit;

public class TestAIDLService implements  ITester {
  // Public
  ////////////////////////////////////////////////////////////
  @Override
...
//  }
  ...
  // Private
  ////////////////////////////////////////////////////////////
  final String TAG = "Java.AIDLService";
  ...
  class LocalThread  implements Runnable {
    ...
    volatile IAIDLService mService = null;
    ...
    void  doCASE_Big_Byte_Array() throws  Exception  {
      ...
      do {
        ...
        String error = null;
        try {
          mService.receiveCASE_Big_Byte_Array(
              Base64.encodeToString(
                  curCase.get_bytes_param_val(null),
                  Base64.DEFAULT)
          );
        } catch (Exception e) {
          Log.e(TAG, "doCASE_Big_Byte_Array()", e);
          error = TAG + "can't write to Parcel, file too BIG: " + e;
          //2019-05-27 07:36:33.594 26407-26654/com.bond.android_ipc E/JavaBinder: !!! FAILED BINDER TRANSACTION !!!  (parcel size = 13559256)
          //2019-05-27 07:36:33.603 26407-26654/com.bond.android_ipc E/Java.AIDLService: LocalThread.run():
        }
        if (null != error)  {
          final String f_error = error;
          TestPresenter.runOnGUIthread(new Runnable() {
            @Override
            public void run() {
              TestPresenter.getGUInterface().showMessage(f_error);
            }
          });
          return;
        }
    ...
    boolean doBind() {
      boolean re = false;
      try {
        //SpecTheme.context.startService(new Intent(SpecTheme.context, AIDLService.class));
        Intent intent = new Intent(SpecTheme.context, AIDLService.class);
        intent.setAction(IAIDLService.class.getName());
        //bindService(intent, mConnection, Context.BIND_AUTO_CREATE);
        //Intent intent = new Intent(SpecTheme.context, AIDLService.class);
        //Intent intent = new Intent();
        //intent.setAction("com.bond.android_ipc.URI.AIDLService");
