  ...
  class LocalThread  implements Runnable {
    ...
    void  doCASE_Big_Byte_Array() throws  Exception  {
      ...
      do {
        ...
        intent.putExtra(StaticConsts.PARM_1tester, ContentPullService.TESTER_TestViaDisk);
        ...
        FileAdapter.saveFileBytes(fileName,
            curCase.get_bytes_param_val(null), SpecTheme.context);
        long time  =  System.nanoTime() - startTime;
        intent.putExtra(StaticConsts.PARM_save_time, time);
        intent.putExtra(StaticConsts.PARM_save_file, fileName);
    ...
    void  doCASE_Strings() throws  Exception  {
      ...
      while (myID == startID) {
        ...
        String fileName = "tmp.tmp";
        FileAdapter.saveFile(fileName, sb.toString(), SpecTheme.context);
        long time  =  System.nanoTime() - startTime;
        Intent intent = new Intent(SpecTheme.context, ContentPullService.class);
        intent.putExtra(StaticConsts.PARM_test_case, curCase.get_case_type());
        intent.putExtra(StaticConsts.PARM_1tester, ContentPullService.TESTER_TestViaDisk);
